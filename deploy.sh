...
ssh "$SERVER" "set -e
  chmod +x $SRC/vpn-start $SRC/vpn-create $SRC/vpn-killswitch $SRC/opencode-vpn $SRC/vpn-rotate $SRC/vpn-add $SRC/vpn-fresh $SRC/vpn-socks
...
ssh "$SERVER" '
  ...
  ls -l '"$BIN"'/vpn-start '"$BIN"'/vpn-create '"$BIN"'/vpn-killswitch '"$BIN"'/opencode-vpn '"$BIN"'/vpn-rotate '"$BIN"'/vpn-add '"$BIN"'/vpn-fresh '"$BIN"'/vpn-socks
